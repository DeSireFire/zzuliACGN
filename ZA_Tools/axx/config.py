...
# 加密用的文件名
# fileName_data = 'z'.encode("utf-8")
fileName_data = 'zzuliacgn'

'''
    网页地址设置
'''
# 网站首页
index_url = "https://tu.aixinxi.net/index.php"
# 登陆地址
login_url = "https://tu.aixinxi.net/includes/userAction.php"
# 退出登录的连接地址
loginOut_url = 'https://tu.aixinxi.net//includes/userAction.php?action=logout'
# 上传文件地址
update_url = 'https://t1-aixinxi-net.oss-us-west-1.aliyuncs.com/'
# 保存信息地址
save_url = 'https://tu.aixinxi.net/includes/save.php'
# 删除文件地址
delete_url = 'https://tu.aixinxi.net/includes/delete_file.php'
# token地址
token_url = 'https://tu.aixinxi.net/includes/token.php'
