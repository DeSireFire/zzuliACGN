...
var MainManager = function() {
		...
		p && ($("#bt_fs").css("display", "block"), $("#bt_fs").click(function(a) {
			...
			case 1:
				...
				break;
			default:
				location.href = "http://www.zzuliacgn.cf/"
			}
		...
		var w, M, I, x, b, C = 0,
			...
			P = new function() {
				...
				this.init = function(t, o) {
					...
					(n = new WebAudioManager).load("/static/ZA_Mikutap/data/track/track.json", r, a, e)
			...
			T = new function() {
				...
				this.init = function(n, t) {
					...
					(i = new WebAudioManager).load("/static/ZA_Mikutap/data/main/main.json", r, a, e)
